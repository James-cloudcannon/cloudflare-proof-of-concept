...
<SnippetsAlert background_color="#F2E2D2" alert_message="test message" color="#c8d5b9" icon="Check"/>

<SnippetsTint tint_color="#000000">testing tint</SnippetsTint>

<SnippetsVideo src="https://www.youtube.com/watch?v=XHvmX3FhTwU"/>
...
<CodeBlock language="javascript">{`// Import what Fortiche generated
