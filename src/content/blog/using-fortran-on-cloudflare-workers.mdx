...
<Figure image_path="https://blog.cloudflare.com/content/images/2024/05/image2.png" alt="Using Fortran on Cloudflare Workers" caption="test caption" text_align="right"/>
