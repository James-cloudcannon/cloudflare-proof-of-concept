...
<CodeBlock lang="stylus" code={`SUBROUTINE add(a, b, res)
...
<CodeBlock lang="tap" code={`$ ls -lh ./output
total 84K
...
<CodeBlock lang="javascript" code={`// Import what Fortiche generated
...
<CodeBlock lang="bash" code={`$ curl https://fortran-add.cfdemos.workers.dev
