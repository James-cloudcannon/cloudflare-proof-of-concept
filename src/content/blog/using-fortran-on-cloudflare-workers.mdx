...
<CodeBlock code="SUBROUTINE add(a, b, res) INTEGER, INTENT(IN) :: a, b INTEGER, INTENT(OUT) :: res res = a + b END" lang="stylus"/>
...
<CodeBlock code="docker run -v $PWD:/input -v $PWD/output:/output xtuc/fortiche --export-func=add add.f90" lang="docker"/>
...
<CodeBlock code="// Import what Fortiche generated
